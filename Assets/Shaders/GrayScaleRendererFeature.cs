...
public sealed class GrayScaleRendererFeature : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        GrayScaleVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<GrayScaleVolumeComponent>();
    ...
    private class CustomPostRenderPass : ScriptableRenderPass
    {
        ...
        [System.Obsolete("This rendering path works in Compatibility Mode only, which is deprecated. Use the render graph API instead.")]
