...
[DisplayInfo(name = "GrayScale")]

// Create the Volume Override by inheriting from VolumeComponent
public sealed class GrayScaleVolumeComponent : VolumeComponent, IPostProcessComponent
{
    // Create a property to control the intensity of the effect, with a tooltip description.
